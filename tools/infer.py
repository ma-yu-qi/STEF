...
def parse_args():
    ...
    parser.add_argument(
        '--inputs', type=str,default='data/dongba/textdet_imgs/train/img_309.jpg', help='Input image file or folder path.')
    parser.add_argument(
        '--out-dir',
        type=str,
        default='results/',
    ...
    parser.add_argument(
        '--det',
        type=str,
        default='configs/textdet/dbnet/dbnet_resnet18_fpnc_1200e_dongba.py',
        help='Pretrained text detection algorithm. It\'s the path to the '
        'config file or the model name defined in metafile.')
    parser.add_argument(
        '--det-weights',
        type=str,
        default='work_dirs/dbnet_resnet18_fpnc_1200e_dongba/epoch_90.pth',
